...
namespace WstCommonTools
{
    public class IniAPI
    {
        ...
        public string[] INIGetAllItems(string iniFile, string section)
        {
        ...
        public string INIGetStringValue(string iniFile, string section, string key, string defaultValue)
        {
        ...
        /// <returns>操作是否成功</returns>
        public bool INIWriteValue(string iniFile, string section, string key, string value)
        {
            if (string.IsNullOrEmpty(section))
            {
                throw new ArgumentException("必须指定节点名称", "section");
        ...
        /// <param name="key">键</param>
        /// <returns>操作是否成功</returns>
        public bool INIDeleteKey(string iniFile, string section, string key)
        {
            if (string.IsNullOrEmpty(section))
            {
                throw new ArgumentException("必须指定节点名称", "section");
